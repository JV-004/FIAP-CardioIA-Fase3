...
#include "config.h"   // ⚠️  Credenciais locais — NÃO commitar (ver config.h.example)
...
// As credenciais são carregadas de config.h (arquivo local, não versionado).
// Copie config.h.example para config.h e preencha com seus dados reais.

const char* ssid          = WIFI_SSID;
const char* senhaWifi     = WIFI_PASSWORD;
...
const char* topicoDados   = TOPICO_DADOS;
const char* topicoAlerta  = TOPICO_ALERTA;
